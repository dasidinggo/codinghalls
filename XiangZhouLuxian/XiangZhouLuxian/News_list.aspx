<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="News_list.aspx.cs" Inherits="XiangZhouLuxian.News_list" %>
...
<div class="newslist">
	<div class="listleft">
    	<div class="listtitle">
        	<a href="index.aspx">香洲群众路线网</a> &nbsp; > &nbsp; <asp:Label ID="lblnewlist" runat="server"></asp:Label>
        </div>
        <div class="listcontent">
            ...
            <asp:Repeater ID="rpnewslist" runat="server">
                <ItemTemplate>
            	<tr>
                	<td class="licontd"><a href='News_detail.aspx?nid=<%#Eval("ID") %>'><%#Eval("title") %></a></td>
                    <td class="datetd"><%# convdate(Eval("times").ToString())%></td>
                </tr>
                </ItemTemplate>
            </asp:Repeater>
            </table>
