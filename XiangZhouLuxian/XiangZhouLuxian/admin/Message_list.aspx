<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Message_list.aspx.cs" Inherits="XiangZhouLuxian.admin.Message_list" %>
...
<body style=" overflow:hidden;">
    ...
    <div class="sonpage">
        ...
        &nbsp; &nbsp; &nbsp;状态：<asp:DropDownList ID="ddlstatus" runat="server">
            ...
            <asp:ListItem Text="通过审核" Value="1"></asp:ListItem>
            ...
            <%--&nbsp; &nbsp; &nbsp; <a id="addaln" class="btnblock" onclick='$("#editarea").css({ display: "block" });' href='NewsHandle.aspx?isupdate=0' target="inproframe">新增</a>--%>
            </div>
            ...
            <asp:Repeater ID="rpMessageList" runat="server">
                <HeaderTemplate>
                    <tr class="headtr">
                        <td width="10%">编号</td>
                        <td>标题</td>
                        <td class="k2h" width="15%">状态</td>
                        <td width="15%">操作</td>
                    </tr>
                </HeaderTemplate>
                <ItemTemplate>
                    <tr>
                        <td><asp:Label ID="lbltid" runat="server" Text='<%#Container.ItemIndex + 1 %>'></asp:Label></td>
...
<%--                        <td width="100"><a href="#1" data_id="<%#Eval("tid") %>" class="datarow">修改</a></td>--%>
                        <td class="k2h"><%#GetStatusname(Eval("status").ToString())%></td>
                        <td><a onclick='$("#editarea").css({ display: "block" });' href='MessageEdit.aspx?id=<%#Eval("ID") %>&kind=<%#Eval("kind") %>' target="inproframe" >查看</a> &nbsp; 
